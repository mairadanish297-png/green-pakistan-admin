...
export default function EventsPage() {
  ...
  async function handleImageUpload(file: File) { setUploading(true); setError(""); try { setForm((current) => ({ ...current, imageUrl: await uploadImage(file) })); } catch { setError("Image upload nahi ho saki. Cloudinary settings check karein."); } finally { setUploading(false); } }
